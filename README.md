...
- Upload your [cuneiformsf-dhr-v25.zip](packaged/cuneiformsf-dhr-v25.zip) file to Jetstream
- Confirm that you DO NOT have the `single package` checkbox checked in your deployment configuration (uncheck it)
- Click the `Deploy` button to deploy the reports to your Salesforce org
